...
SECRET_KEY = 'u%s5em5_3fw!7m3s%by^2q_(00jj^6gd!h_4yxb81_5ivwyx^%'
...
SESSION_CACHE_ALIAS = 'session'#指定session保存到redis//127.0.0.1:6379/1号数据库中
